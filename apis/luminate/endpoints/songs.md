...
Song-level (composition) metadata and consumption data. A song may encompass multiple recordings (ISRCs).

**Path Parameters:**

| Name | Type | Required | Description |
|------|------|----------|-------------|
| id | String | yes | Luminate song ID or ISRC |
...
|-------|------|-------------|
| id | String | Luminate song ID |
| isrc | Array[String] | ISRC codes |
...
| relationships | Array | Related entities |
| metrics | Array | Consumption data |
